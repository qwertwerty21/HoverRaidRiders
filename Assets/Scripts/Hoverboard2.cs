...
public class Hoverboard2 : MonoBehaviour
{
  ...
  private void Awake()
  {
    m_WheelColliderFrontLeft = GameObject.FindGameObjectWithTag("HoverboardWheelColliderFrontLeft").GetComponent<WheelCollider>();
    m_WheelColliderFrontRight = GameObject.FindGameObjectWithTag("HoverboardWheelColliderFrontRight").GetComponent<WheelCollider>();
    m_WheelColliderBackLeft = GameObject.FindGameObjectWithTag("HoverboardWheelColliderBackLeft").GetComponent<WheelCollider>();
    m_WheelColliderBackRight = GameObject.FindGameObjectWithTag("HoverboardWheelColliderBackRight").GetComponent<WheelCollider>();
