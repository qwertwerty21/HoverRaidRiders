...
public class Hoverboard : MonoBehaviour
{
  ...
  private void Awake()
  {
    ...
    m_RigidBody = m_Hoverboard.GetComponent<Rigidbody>();
    m_HoverboardPoints = m_Hoverboard.FindGameObjectsWithTag("HoverboardPoint");
  }
  ...
  private void FixedUpdate()
  {
    ...
    m_RigidBody.AddForce(vertical * m_MoveForce * Camera.main.transform.forward, ForceMode.Acceleration);
