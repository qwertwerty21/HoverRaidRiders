...
public class Hoverboard : MonoBehaviour
{
  ...
  void OnCollisionEnter(Collision collision)
  {
    ...
    {
      Debug.Log("Set To 0 AngularVelocity" + m_RigidBody.angularVelocity);
      //Stop rotating
      // m_RigidBody.angularVelocity = Vector3.zero;

      // // add steer stability force
      // Vector3 worldVelocity = m_RigidBody.angularVelocity;
      // Vector3 localVelocity = transform.InverseTransformVector(worldVelocity);
      ...
      m_RigidBody.AddRelativeTorque(Vector3.forward * dot * 100 * Time.deltaTime, ForceMode.Acceleration);
    }
  }
}
