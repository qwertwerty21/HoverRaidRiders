...
public class Hoverboard : MonoBehaviour
{
  ...
  private void FixedUpdate()
  {
    ...
    Ray centerOfMassDownRay = new Ray(m_HoverboardAccelPoint.transform.position, Vector3.down);
    Debug.DrawRay(m_HoverboardAccelPoint.transform.position, Vector3.down, Color.blue);

    if (Physics.Raycast(centerOfMassDownRay, out centerOfMassHit, Mathf.Infinity))
    {
