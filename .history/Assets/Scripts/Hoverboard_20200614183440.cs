...
public class Hoverboard : MonoBehaviour
{
  ...
  private void Update()
  {
    ...
    Collider[] colliders = Physics.OverlapSphere(m_HoverboardAccelPoint.transform.position, 1f, m_GroundLayerMask);
  ...
  private void OnDrawGizmosSelected()
  {
    ...
    Gizmos.DrawWireSphere(m_HoverboardAccelPoint.transform.position, 1f);
  }
}
