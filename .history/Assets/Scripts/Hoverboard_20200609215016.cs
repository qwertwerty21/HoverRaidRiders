...
public class Hoverboard : MonoBehaviour
{
  ...
  private void FixedUpdate()
  {
    ...
    float clampedRotationX = Mathf.Clamp(transform.rotation.x, -m_MaxRotationX, m_MaxRotationX);
    float clampedRotationZ = Mathf.Clamp(transform.rotation.z, -m_MaxRotationZ, m_MaxRotationZ);

    transform.eulerAngles = new Vector3(clampedRotationX, transform.rotation.y, clampedRotationZ);
  }
