...
public class Hoverboard2 : MonoBehaviour
{
  ...
  private void Awake()
  {
    m_WheelColliderFrontLeft = GameObject.FindGameObjectWithTag("WheelColliderFrontLeft");
    m_WheelColliderFrontRight = GameObject.FindGameObjectWithTag("WheelColliderFrontRight");
    m_WheelColliderBackLeft = GameObject.FindGameObjectWithTag("WheelColliderBackLeft");
    m_WheelColliderBackRight = GameObject.FindGameObjectWithTag("WheelColliderBackRight");
