...
public class Hoverboard : MonoBehaviour
{
  ...
  private void LateUpdate()
  {
    ...
    x = x > 180f ? x - 360f : x;
    x = Mathf.Clamp(x, -m_MaxRotationX, m_MaxRotationX);
    float z = transform.eulerAngles.z;
    z = z > 180f ? z - 360f : z;
    z = Mathf.Clamp(z, -m_MaxRotationZ, m_MaZRotationZ);


    // Converts our numbers into euler angles.
    Quaternion rotation = Quaternion.Euler(x, transform.eulerAngles.y, z);
