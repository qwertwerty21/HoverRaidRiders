...
public class Hoverboard : MonoBehaviour
{
  ...
  void OnCollisionEnter(Collision collision)
  {
    ...
    {
      Debug.Log("AngularVelocity before" + m_RigidBody.angularVelocity);
      //Stop rotating
      // m_RigidBody.angularVelocity = Vector3.zero;
      m_Rigidbody.constraints = m_RigidBody.FreezeRotationX;
      // // add steer stability force
      ...
      Debug.Log("AngularVelocity after" + m_RigidBody.angularVelocity);
