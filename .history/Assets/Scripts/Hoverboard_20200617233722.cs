...
public class Hoverboard : MonoBehaviour
{
  ...
  public void Move(float horizontal, float vertical, bool isDrifting)
  {
    ...
    if (isDrifting)
    {
      m_RigidBody.AddRelativeForce(vertical * m_CurrentSpeed * transform.forward / m_DriftSpeedReductionFactor, ForceMode.Impulse);
    }
    else
    {
      m_RigidBody.AddRelativeForce(vertical * m_CurrentSpeed * transform.forward, ForceMode.Acceleration);
    }
