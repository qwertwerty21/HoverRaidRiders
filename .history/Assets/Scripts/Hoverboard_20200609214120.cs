...
{
  public float m_MaxRotationX = 25f;
  public float m_MaxRotationZ = 35f;
  ...
  {
    float clampedRotationX = Mathf.Clamp(transform.localEulerAngles.x, -m_MaxRotationX, m_MaxRotationX);
    float clampedRotationZ = Mathf.Clamp(transform.localEulerAngles.z, -m_MaxRotationZ, m_MaxRotationZ);

    transform.localEulerAngles = new Vector3(clampedRotationX, transform.localEulerAngles.y, clampedRotationZ);
  }
