...
public class Hoverboard : MonoBehaviour
{
  ...
  private void Update()
  {
    ...
    Collider[] colliders = Physics.OverlapSphere(m_HoverboardAccelPoint.transform.position, .5f, m_GroundLayerMask);
  ...
  private void OnDrawGizmosSelected()
  {
    ...
    Gizmos.DrawWireSphere(m_HoverboardAccelPoint.transform.position, .5f);
  }
}
