...
public class Hoverboard : MonoBehaviour
{
  ...
  public void Move(float horizontal, float vertical)
  {
    ...
    m_RigidBody.AddForce(vertical * m_CurrentSpeed * transform.forward.eulerAngles, ForceMode.Acceleration);
    ...
    // add turning force
    m_RigidBody.AddTorque(horizontal * m_TorqueForce * transform.rotation, ForceMode.Force);
