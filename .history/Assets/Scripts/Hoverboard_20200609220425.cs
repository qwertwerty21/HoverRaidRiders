...
{
  public float m_MaxRotationX = 180f;
  public float m_MaxRotationZ = 180f;
  ...
  //   float clampedRotationX = Mathf.Clamp(transform.eulerAngles.x, -m_MaxRotationX, m_MaxRotationX);
  //   float clampedRotationZ = Mathf.Clamp(transform.eulerAngles.z, -m_MaxRotationZ, m_MaxRotationZ);
  //   Debug.Log("ClampedEulerAngles" + new Vector3(clampedRotationX, transform.eulerAngles.y, clampedRotationZ));
