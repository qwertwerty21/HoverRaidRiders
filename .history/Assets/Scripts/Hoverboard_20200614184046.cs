...
public class Hoverboard : MonoBehaviour
{
  ...
  private void Awake()
  {
    ...
    m_HoverboardGroundCheckPoint = GameObject.FindGameObjectWithTag("HoverboardAccelPoint");
  ...
  private void Update()
  {
    ...
    Collider[] colliders = Physics.OverlapSphere(m_HoverboardGroundCheckPoint.transform.position, 1f, m_GroundLayerMask);
  ...
  private void OnDrawGizmosSelected()
  {
    ...
    Gizmos.DrawWireSphere(m_HoverboardGroundCheckPoint.transform.position, 1f);
  }
}
